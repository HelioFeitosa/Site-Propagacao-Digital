...
function resolveLocalTurn(message, currentState = {}) {
  ...
  if (/(o que eu vendo|com o que eu trabalho)/.test(value)) {
    const product = state.productsOrServices || state.businessType;
  ...
  if (/(o que eu quero melhorar|qual e meu objetivo)/.test(value)) {
